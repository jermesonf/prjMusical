...
using System.Data.SqlClient;
    ...
    public class ClasseConexao
    {
        ...
        public SqlConnection conectar(){
             ...
             * "\\SQLEXPRESS" -> Utilize o SGBD SQLEXPRESS (pode receber outro nome caso o usuario mude na instalaçao)
             */
            String strConexao = "Password=etesp; Persist Security Info=True; User ID=sa; Initial Catalog=musical; Data Source=" + Environment.MachineName + "\\SQLEXPRESS" ;
